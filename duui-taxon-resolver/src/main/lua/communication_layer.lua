...
RecognizedTaxon = luajava.bindClass("org.texttechnologylab.annotation.type.RecognizedTaxon")
TaxonResolutionClass = Class:forName("org.texttechnologylab.annotation.type.TaxonResolution")
