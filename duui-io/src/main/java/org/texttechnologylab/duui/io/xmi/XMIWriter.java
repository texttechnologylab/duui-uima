package org.texttechnologylab.duui.io.xmi;
...
public class XMIWriter extends JCasFileWriter_ImplBase {
    ...
    /**
     * Defines the XML version used for serializing the data. The default is XML {@code "1.1"}.
    ...
    @ConfigurationParameter(name = PARAM_VERSION, mandatory = true, defaultValue = "1.1")
