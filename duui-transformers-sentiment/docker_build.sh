...
export TEXTIMAGER_DUUI_TRANSFORMERS_SENTIMENT_ANNOTATOR_VERSION=0.1.3
...
docker tag \
  ${DOCKER_REGISTRY}${TEXTIMAGER_DUUI_TRANSFORMERS_SENTIMENT_ANNOTATOR_NAME}:${TEXTIMAGER_DUUI_TRANSFORMERS_SENTIMENT_ANNOTATOR_VERSION}${TEXTIMAGER_DUUI_TRANSFORMERS_SENTIMENT_VARIANT}${TEXTIMAGER_DUUI_TRANSFORMERS_SENTIMENT_ANNOTATOR_CUDA} \
  ${DOCKER_REGISTRY}${TEXTIMAGER_DUUI_TRANSFORMERS_SENTIMENT_ANNOTATOR_NAME}:latest${TEXTIMAGER_DUUI_TRANSFORMERS_SENTIMENT_VARIANT}${TEXTIMAGER_DUUI_TRANSFORMERS_SENTIMENT_ANNOTATOR_CUDA}
