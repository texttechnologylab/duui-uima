# See https://github.com/pysentimiento/pysentimiento/blob/master/pysentimiento/preprocessing.py
# Commit: 91ca3c24a0af22330490d463c09772fc5f3360fd
import emoji
import re
...
SUPPORTED_MODEL = {
    "finiteautomata/bertweet-base-sentiment-analysis": {
        "version": "cf6b0f60e84096e077c171fe3176093674370291",
        "max_length": 130,
        "mapping": {
            "POS": 1,
            "NEU": 0,
        ...
        "preprocess": lambda text: preprocess_tweet(text, lang="en", user_token="@USER", url_token="HTTPURL"),
        "languages": ["en"]
    },
}
