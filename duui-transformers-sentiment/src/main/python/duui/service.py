...
class Settings(BaseSettings):
    # Name of annotator
    textimager_duui_transformers_sentiment_annotator_name: str

    # Version of annotator
    textimager_duui_transformers_sentiment_annotator_version: str

    # Log level
    textimager_duui_transformers_sentiment_log_level: Optional[str]

    # Model LRU cache size
    textimager_duui_transformers_sentiment_model_cache_size: int
