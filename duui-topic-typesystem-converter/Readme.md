[![Version](https://img.shields.io/static/v1?label=duui-topic-typesystem-converter&message=0.1.0&color=blue)](https://docker.texttechnologylab.org/v2/duui-transformers-topic/tags/list)
