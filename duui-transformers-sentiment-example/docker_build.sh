...
# Log level in Python
export TTLAB_DUUI_TRANSFORMERS_SENTIMENT_EXAMPLE_LOG_LEVEL=DEBUG

# Model cache size
export TTLAB_DUUI_TRANSFORMERS_SENTIMENT_EXAMPLE_MODEL_CACHE_SIZE=1
...
docker build \
  ...
  --build-arg TTLAB_DUUI_TRANSFORMERS_SENTIMENT_EXAMPLE_LOG_LEVEL \
