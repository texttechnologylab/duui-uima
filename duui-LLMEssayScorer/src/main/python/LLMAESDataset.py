...
# Copy from https://github.com/Xiaochr/LLM-AES/blob/main/dataset_info.py
set_1_prompt = """
...
# The examples listed here are only showcases, not exactly the examples used in the experiments
set_1_examples = """
Score Point 1 Example: 
...
Paterson is right. One person may have a problem with a certain book – he raises people against it – the book is banned. Another woman may not like a song because of negative ideas – she rounds up other critics – the song is banned. A parent may find a certain movie inappropriate and offensive – he creates petitions banning it – the movie is banned. You will never find them in any library anywhere. The idea here is that everyone will have problems with something or the other, but if we start getting rid of those things we ultimately end up with nothing at all. Control, not censor. Do not destroy others opinions based on yours. They may be attacking yours, but by censoring them, you are doing the same thing.

Example 2:
Domain 1 Score: 4
Domain 2 Score: 4
Allowing libraries to censor material is wrong. The libraries shouldn’t be allowed to tell you what you can and can’t read. It should be up to the person to decide if the material is against their moral values, so they can decide whether or not they want to read it. The library should allow you to read what you want.
...
Domain 1 Score: 3
Domain 2 Score: 3
Yes, I think that certain magizines should not be put into libraries due to either bad language or unexceptable photos of grown people.
...
Domain 1 Score: 2
Domain 2 Score: 2
I do think that there are books that should be removed because some people take some things offensive. Some people may think that the book may be wrong because of the religion. And some people may not like what the book, movie, or music is teaching their child.
...
Score 1 Example:
The mood created by the author was happiness. Because every one came together as a family and they look out for each other when they were in need. They also helped each other out and were kind and friendly.
"""
...
Score 1 Example:
In Marcia Amidon Lüsted's excerpt, The Mooring Mast, many obstacles had the engineers of the Empire state building looking for a new way to dock dirigibles. One obstacle they had to face was the steel work of the building. The pressure of the wind and the dirigibles load had cost the company @MONEY1. Secondly, they had to design a few special floors for the passengers of the dirigibles. One floor would be for baggage and suitcases while a special observation deck was set up for passengers to exit or enter the ship. Lastly, the building would now be 102 floors and would need to be very durable so special materials were needed to be brought in and used to create the building. All in all, the Empire State Building engineers had to overcome many obstacles when constructing the 1,250 ft. building.

Score 0 Example:
Al Smith was a very competitive person: one of @CAPS1 Al had to go through is competing with another building and he had to make his building taller Than the Chrysler building. Wich in @DATE1 if he didn't make his building taller he would of lost the tittel of The tallest building in new york
"""
...
Example 3:
Idea Score: 0, Organization Score: 1, Style Score: 1, Conventions Score: 1
...
set_8_examples = """
Example 1:
Ideas and Content Score: 6, Organization Score: 6, Voice Score: 6, Word Choice Score: 5, Sentence Fluency Score: 6, Convention Score: 6
...
Example 2:
Ideas and Content Score: 5, Organization Score: 4, Voice Score: 5, Word Choice Score: 4, Sentence Fluency Score: 4, Convention Score: 4
...
Example 3:
Ideas and Content Score: 3, Organization Score: 3, Voice Score: 3, Word Choice Score: 3, Sentence Fluency Score: 3, Convention Score: 3
...
true_exercise = {
    1: """
You are Sam. Please read and reply to your friend, Jim’s email.
Dear Sam,
How are you doing? I have recently become very interested in the Chinese language and would like to learn it by myself during my spare time. But I don’t know the best way to learn it. Could you please give me some suggestions?
Looking forward to your reply!
Yours,
Jim""",
    2: """
While ebooks have become a popular method of reading, there’s something about the feel of an old-fashioned paper book. In your opinion, which is better: ebooks or paper books?
""",
    3: """
Please introduce a learning app that you find useful. You can write from the following aspects.
a. What is it?
b. How do you use it to learn something?
c. Why do you find it useful for learning?
""",
    4: """
Have you heard about FOMO (Fear of Missing Out)? Learn something about it before you do the writing exercise. Do you know someone who suffers from FOMO? What suggestions would you give to help them change themselves regarding this?
""",
    5: """
“Cyber risk” is an increasing concern in our connected world. What can we do about it? Write about how you and your classmates could protect yourselves in terms of cybersecurity.
""",
    6: """
Write about: “The Most Unforgettable Celebration Event”. 
Requirement:
- mention the reason why you want to introduce the event;
- write the place, time, occasion and people involved in the event;
- use action verbs and linking words to put them in the right order;
- describe your feeling at the end of the event.
""",
    7: """
More and more people nowadays are becoming phubbers (People who can't help checking their phones all day long are known as phubbers. Phubbing tends to involve not only young people but also the elderly).
How can we guide phubbers to look up? In your English class, there was a speech themed "Refuse to be a Phubber". Please write a speech (within 120 words) on this topic.
Points to consider:
Do you see phubbers around you? Reasons for them becoming phubbers.
The impact of being a phubber on studies and daily life.
Suggestions on how to avoid becoming a phubber.
""",
    8: """
Bike-sharing provides immense convenience to people, but issues like random parking and intentional damage also arise. Assuming you are the student council president Li Hua, please write a letter to the school newspaper calling on fellow students to use and take care of shared bikes responsibly (within 120 words).
Points to address:
Advantages of bike-sharing and the problems it presents.
Propose initiatives to address these issues.
""",
    9: """
Write an essay about how art is used to express emotions and give examples from different art forms such as sculpture, painting, and performance art.
""",
    10: """
Based on the following news article, please complete the following writing task.

Chinese Brands Find Fame
When you want to buy a pair of running shoes, will you choose Nike or Li-Ning? It’s a choice between local and foreign brands.
According to a recent survey by the Global Times Research Center, Chinese people generally prefer buying local brands over foreign brands. They are drawn by the low price, good quality and creative design.
Some Chinese brands have risen in recent years. They have even started to win some fans abroad. A global survey by research group Ipsos showed that 71 percent of consumers said Chinese brands are important to them.
Chinese brands like Huawei, Xiaomi, DJI, Feiyue, Li-Ning, Shein, and Huaxizi have all become more popular overseas. For example, Huawei is the world’s second-biggest mobile phone company and a top telecoms equipment manufacturer, Time reported. DJI holds 70 percent of the global drone market. Shein, a “fast fashion” brand, saw its operating income reach more than 10 billion dollars last year, a 100-percent increase over the previous year, according to Global Times. It has grown at this rate for eight years in a row. European customers say the brand is affordable, fashionable and of high quality.
In the past, “made in China” made people think of cheap, low-quality goods. But that seems to be changing. Experts say Chinese brands will continue to expand over the next 10 years.

Writing Task:
Next week, Beijing will host a promotional event for renowned domestic and international brands. As the representative of a Chinese brand, write a letter to the event organizer, Jim, expressing your intention to participate. The content of the letter should include:
The characteristics of the Chinese brand and its current development status both domestically and internationally.
Plans for the Chinese brand to further enhance its reputation.
"""
}
...
Content First: When grading, first assess whether the answer is relevant to the question. If the content is judged as zero, then language and structure are also scored zero. If content is missing, downgrade directly in the content section, and it cannot pass. If the content is complete, focus on language.

Grading Order: First determine the grade level. Then score based on language. It is recommended to initially take the median value after setting the grade, and then decide whether to add or subtract a point.
"""

true_examples = """
Example 1: 
Total Score: 11, Content Score: 4, Language Score: 4.5, Structure Score: 2.5
Dear Jim, How is everything going! We are going to have a graduation ceremony for Grade 12, and I have some ideas about designing this campaign. Wondering you have experiences about it, would you give me some advice for me? I want to launch a ball in the dinning hall as the basic pattern,which mean we will be more mature. Then, there will be lecture of president and student representation. We will have a lunch for graduation at dinning hall. Finally, we will write gratitude letters to classmates and teacher and we will give flowers to our favorate teacher. Looking forward to your reply! Thanks for your advice. Yours, LiHua.

Example 2:
Total Score: 16.5, Content Score: 6.5, Language Score: 6.5, Structure Score: 3.5
Greetings! My school is currently preparing for the graduation ceremony of Senior 3 students, with all students free to contribute ideas. I'm writing to ask your opinions on the activity I've come up with. I think it would be great collect photos capturing the memorable events of the past 3 years from the and present them during the ceremony.students The content could include spring outings, sports meetings, and so on. In my view, showing the photos can help the students recall the happy memories together, thus strengthen their bonds with each other,letting them value time in high school more. Moreover, reviewing past events is also a desirable way to end a chapter of our growth, after which everyone can welcome a brand-new start in life. What do you think of my thoughts?I'm looking forward to your suggestions.

Example 3:
Total Score: 5, Content Score: 2, Language Score: 2, Structure Score: 1
Hi jim How it is going? Knowing you're good at organize life allicity is won't to Hongs you give. Two people advice for me from you because I want enter the "collect in ansing plan". First, I hope , since from photo by student in about school life and then make a video, to start of allowing, In addition, I'll invite some classmate to law good, to give some wish and find populars plays some experts. They can made a If you have any suggestion does feel free in talk with me. Expect your reply.
"""
