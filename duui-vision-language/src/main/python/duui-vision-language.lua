...
MetaData = luajava.bindClass("org.texttechnologylab.annotation.model.MetaData")
Result = luajava.bindClass("org.texttechnologylab.type.llm.prompt.Result")
...
function deserialize(inputCas, inputStream)
    ...
    if results['errors'] ~= nil then
        ...
        for index_i, error in ipairs(errors) do
            local warning_i = luajava.newInstance(AnnotationComment, inputCas)
