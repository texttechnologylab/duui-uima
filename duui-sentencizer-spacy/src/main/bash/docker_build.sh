...
export DUUI_SENTENCIZER_SPACY_CUDA=
#export DUUI_SENTENCIZER_SPACY_CUDA=-cuda
...
docker build \
  ...
  --build-arg DUUI_SENTENCIZER_SPACY_CUDA \
  -t ${DOCKER_REGISTRY}${DUUI_SENTENCIZER_SPACY_ANNOTATOR_NAME}-${DUUI_SENTENCIZER_SPACY_VARIANT}${DUUI_SENTENCIZER_SPACY_CUDA}:${DUUI_SENTENCIZER_SPACY_ANNOTATOR_VERSION} \
  -f "src/main/docker/Dockerfile${DUUI_SENTENCIZER_SPACY_CUDA}" \
  .

docker tag \
  ${DOCKER_REGISTRY}${DUUI_SENTENCIZER_SPACY_ANNOTATOR_NAME}-${DUUI_SENTENCIZER_SPACY_VARIANT}${DUUI_SENTENCIZER_SPACY_CUDA}:${DUUI_SENTENCIZER_SPACY_ANNOTATOR_VERSION} \
  ${DOCKER_REGISTRY}${DUUI_SENTENCIZER_SPACY_ANNOTATOR_NAME}-${DUUI_SENTENCIZER_SPACY_VARIANT}${DUUI_SENTENCIZER_SPACY_CUDA}:latest
