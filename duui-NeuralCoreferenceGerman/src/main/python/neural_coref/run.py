...
from neural_coref.tensorize import CorefDataProcessor
from neural_coref import util
import argparse
import time
from os.path import join
from os import remove
from neural_coref.metrics import CorefEvaluator
...
class Runner:
    ...
    def initialize_model(self, saved_suffix=None):
        if self.config['incremental']:
            print("Load IncrementalCorefModel")
            model = IncrementalCorefModel(self.config, self.device)
        else:
            print("Load CorefModel")
