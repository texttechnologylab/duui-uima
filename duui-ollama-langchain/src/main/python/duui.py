...
class Settings(BaseSettings):
    ...
    class Config:
        env_prefix = 'duui_ollama_langchain_'
...
logger.info("TTLab TextImager DUUI Ollama Langchain")
...
app = FastAPI(
    ...
    description="TTLab TextImager DUUI Ollama Langchain",
...
def post_process(request: TextImagerRequest) -> TextImagerResponse:
    ...
    try:
        ...
        # llm_args["disable_streaming"] = True  # always disable streaming
