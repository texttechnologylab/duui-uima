...
from GenreSpeech import GenreCheck
...
lua_communication_script_filename = "duui_genre.lua"
...
def load_model(model_name):
    model_i = GenreCheck(model_name, device)
    return model_i
...
def process_selection(model_name, selection):
    ...
    with model_lock:
        ...
        results = classifier.genre_prediction(texts)
