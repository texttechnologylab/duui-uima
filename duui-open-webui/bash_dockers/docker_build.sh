...
# docker push ${DOCKER_REGISTRY}${MM_ANNOTATOR_NAME}-${MM_ANNOTATOR_CUDA}:${MM_ANNOTATOR_VERSION}
# docker push ${DOCKER_REGISTRY}${MM_ANNOTATOR_NAME}-${MM_ANNOTATOR_CUDA}:latest
