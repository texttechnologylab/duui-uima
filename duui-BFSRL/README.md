# Brute Force Semantic Role (BFSRL) tagger
...
@misc{Bundan:Abrami:2025,
  ...
  title          = {Brute Force Semantic Role as DUUI-Komponent},
  year           = {2023},
  howpublished   = {https://github.com/texttechnologylab/duui-uima/duui-BFSRL}
}
