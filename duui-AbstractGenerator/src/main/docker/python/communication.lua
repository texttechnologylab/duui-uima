...
-- TextAbstract = luajava.bindClass("org.texttechnologylab.annotation.TextAbstract")
...
function deserialize(inputCas, inputStream)
    ...
    local abstract = results["abstract"]

    local pAbstract = luajava.newInstance("org.texttechnologylab.annotation.TextAbstract", inputCas)
    pAbstract:setValue(abstract)
    pAbstract:addToIndexes()
